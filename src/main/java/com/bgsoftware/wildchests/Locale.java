...
public final class Locale {
    ...
    public static Locale CHEST_INFO_TRASH_MODE = new Locale("CHEST_INFO_TRASH_MODE");
    public static Locale CHEST_INFO_TRASH_INTERVAL = new Locale("CHEST_INFO_TRASH_INTERVAL");
